...
export class MkgtruApiService {
  ...
  async getNews(): Promise<ITitledDocumentInfo[]> {
    const elements = await getElementsFromPage("https://mkgt.ru/index.php?option=com_minitekwall&task=masonry.getContent&widget_id=2&page=19999&tag_operator=OR&date_format=Y-m&grid=masonry", 'h3 a');
